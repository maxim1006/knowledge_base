...
(function(blog, $, undefined) {
    ...
    blog.jsonCallback = function(data) {
        ...
        posts = $.map(posts, function(post) { //TODO
    ...
    blog.displayList = function(posts) {
        ...
        $.each(posts, function(_, post) { //TODO
    ...
    blog.changeFilter = function(e) {
        ...
        if (e.target.matches("input")) {
            ...
            blog.categories = $(nodes).map(function() { //TODO
                return $(this).is(":checked") ? //TODO
                    $(this).data("category") : null; //TODO
            }).get();
    ...
    blog.filterList = function(categories) {
        ...
        [].forEach.call(nodes, function(node) {
            ...
            if (!found) {
                $.each(categories, function(i, category) { //TODO
                    var tags = $this.data("categories"); //TODO
                    if (~$.inArray(category, tags)) { //TODO
                        found = true;
                        return false;
                    }
                });
    ...
    blog.displayDetail = function(url) {
        var post = $.grep(blog.posts, function(post) { //TODO
